#!/bin/bash
# =======================================================================
# Regression v5: spectral auxiliary loss for short-R frequency matching
#
# Same model as v4 (conditioned frequencies, 512 hidden, 4 layers)
# + phase-invariant spectral loss that provides frequency gradients
#   where MSE is in a flat region (Δω·T > 2π → MSE saturated)
#
# Reuses v2 dataset.
#
# Usage: cd $SCRATCH/generative-quantum-states && bash slurm/regression_v5.sh
# =======================================================================
set -euo pipefail
...
echo "=== Regression v5 (spectral loss) ==="
echo "  tag:     ${TAG}"
