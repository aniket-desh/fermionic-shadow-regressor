#!/bin/bash
# =======================================================================
# Regression v7: same as v6 but with optimized datagen
#
# Key optimizations in regression_dataset.py:
#   - Cache Givens sub-decompositions (was recomputed 65M times, now 1K)
#   - Vectorized observable accumulation (numpy instead of Python loop)
#
# Usage: cd $SCRATCH/generative-quantum-states && bash slurm/regression_v7.sh
# =======================================================================
set -euo pipefail
...
echo "=== Regression v7 (optimized datagen) ==="
echo "  tag:     ${TAG}"
